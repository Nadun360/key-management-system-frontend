<template>
	<b-container fluid="xl">
        <b-row>
        	...
        	<b-col cols="5">
        		<b-card class="mt-3" header="Create a Building" >
					...
					<!-- keyID -->
						<b-form-group
			                ...
			                label="keyID:" 
			                label-for="keyID1"
			                description="Key id that you allocated to this building"
			                >
			                <b-form-input
			                  id="keyID1"
			                  v-model="form.keyID"
        	...
        	<b-col cols="5">
        		...
        		<b-card class="mt-3" header="Update a Building" >
        			<div v-if="beforeFind">
        				<b-form @submit="onSubmit2">
	        				<b-form-group
								...
								description="Enter the Building ID that you want to edit"
								>
								<b-form-input
									id="buildingID2"
