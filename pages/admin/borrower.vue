<template>
	<b-container fluid="xl">
        <b-row>
        	...
        	<b-col cols="5">
        		<b-card class="mt-3" header="Create a Borrower" >
    				...
    				<!-- Fname -->
						<b-form-group
							...
							label="First Name:"
							label-for="fname1"
							description="Enter the first name of the borrower"
							>
							<b-form-input
								id="fname1"
								v-model="form.fname"
						...
						<b-form-group
							...
							label="Last Name:"
							label-for="lname1"
							description="Enter the last name of the borrower"
							>
							<b-form-input
								id="lname1"
								v-model="form.lname"
						...
						<b-form-group
							...
							label="Type Of Staff:"
							label-for="tos1"
							description="Select the staff  type of the borrower"
							>
							<b-form-select
								id="tos1"
						...
						<b-form-group
							...
							label="Designation:"
							label-for="desi1"
							description="Select the designation of the borrower"
							>
							<b-form-select
								id="desi1"
        	...
        	<b-col cols="5">
        		...
        		<b-card class="mt-3" header="Update a Borrower" >
        			<div v-if="beforeFind">
        				<b-form @submit="onSubmit2">
	        				<b-form-group
								...
								label="Borrower ID:"
								label-for="bid2"
								description="Enter the Borrower ID that you want to edit"
								>
								<b-form-input
									id="bid2"
