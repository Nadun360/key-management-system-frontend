<template>
	<b-container fluid="xl">
        <b-row>
        	...
        	<b-col cols="5">
        		<b-card class="mt-3" header="Create a Key" >
    				...
    				<!-- Key ID -->
						<b-form-group
							...
							label="Key ID:"
							label-for="keyid"
							description="Enter an integer as a key id"
							>
							<b-form-input
								id="keyid"
								v-model="form.keyID"
					...
					<!-- no of keys -->
						<b-form-group
							...
							label="No Of Keys:"
							label-for="noofkeys"
							description="Enter the nnumber of keys that have in the key set"
							>
							<b-form-input
								id="noofkeys"
					...
					<!-- availability -->
						<b-form-group
			                ...
			                description="Select whether the key is available or not"
			                >
			                <b-form-select
			                  id="availability1"
        	...
        	<b-col cols="5">
        		...
        		<b-card class="mt-3" header="Update a Key" >
        			<div v-if="beforeFind">
        				<b-form @submit="onSubmit2">
	        				<b-form-group
								...
								label="Key ID:"
								label-for="keyid2"
								description="Enter the Key ID that you want to edit"
								>
								<b-form-input
									id="keyid2"
									v-model="form2.keyID"
